...
class StockVisualizer:
    ...
    def plot_all_in_one_chart(self):
        ...
        po.plot(figure, filename=os.path.join(GlobalConfig.PROGRAMMING_OUTPUTS_BASE_PATH,
                                              self.single_stock_recording_list[0].name, "All_in_one_plot.html"),
                auto_open=False)
    ...
    def plot_stock_features(self):
        ...
        vol_fluc_trace = go.Scattergl(x=date_list, y=vol_fluc_list, mode='lines+markers',
                                      ...
                                      text='Volume standard deviation between ' + str(start_time) + ' and ' + str(
                                          end_time),
                                      showlegend=True,
                                      hoverinfo='text',
                                      opacity=0.7,
        ...
        layout_plot_1 = dict(
            title=ticker + '<br>Daily Volume Features between ' + str(start_time) + ' and ' + str(end_time),
        ...
        layout_plot_2 = dict(
            title=ticker + '<br>Daily Stock Price Features between ' + str(start_time) + ' and ' + str(end_time),
            xaxis=dict(title='Date',
                       titlefont=dict(family='Courier New, monospace', size=18, color='#7f7f7f')),
