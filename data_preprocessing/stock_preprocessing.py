...
class StockParser:
    ...
    def create_stock_feature_dict(self, single_stock_recording_list, start_time, end_time,
        ...
        for single_stock_recording in single_stock_recording_list:
            single_stock_recording_date_dict.get(single_stock_recording.time_stamp.date()).append(
                single_stock_recording)
    ...
    @staticmethod
    def extract_value_lists_from_ssr_list(single_stock_recording_list):
    ...
    @staticmethod
    def prepare_for_json(dict_item):
